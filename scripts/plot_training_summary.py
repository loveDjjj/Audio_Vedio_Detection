...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Plot train/val curves from a training summary.json file.")
...
def main() -> int:
    ...
    result = plot_training_summary(summary_path=args.summary, output_path=output_path)
    print(result)
    return 0
